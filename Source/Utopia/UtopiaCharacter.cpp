...
AUtopiaCharacter::AUtopiaCharacter()
{
	...
	AttributeSet = CreateDefaultSubobject<UUtopiaAttributeSet>("AttributeSet");
}

UAbilitySystemComponent* AUtopiaCharacter::GetAbilitySystemComponent() const
{
	return AbilitySystemComponent;
}

void AUtopiaCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AUtopiaCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AUtopiaCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AUtopiaCharacter::Look);
	}
	else
	{
...
void AUtopiaCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
